      ...
      <View>
        <View style={{ flexDirection: "row" }}>
          ...
          <View style={{ paddingLeft: 10 }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between", paddingRight: 70 }}>
              <Text style={{ ...commonStyles.font12Regular }}>Julie C.</Text>
              <Text style={{ ...commonStyles.font12Regular }}>4.5 ⭐⭐⭐⭐⭐</Text>
              <Text style={{ ...commonStyles.font12Regular }}>22/07/24</Text>
            </View>
            <Text style={{ ...commonStyles.font12Regular, width: "80%" }}>"Great event, well organized and the venue was perfect!"</Text>
          </View>
        </View>
        <VectorIcon groupName='MaterialCommunityIcons' name='share-outline' size={25} color={Colors.Pink} style={styles.sharevci} />
        {!isLastItem && <View style={{ borderBottomWidth: 1, borderColor: Colors.grey }}></View>}
        <SizeBox size={5} />
      </View>
    );
  };
