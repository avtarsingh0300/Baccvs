import { SafeAreaView, ScrollView, StyleSheet, Text, TextInput, View, FlatList, Image } from 'react-native';
import React, { useState } from 'react';
import { Colors } from '../../Utilities/Styles/colors';
import LinearGradient from 'react-native-linear-gradient';
import { KeyboardAwareScrollView } from 'react-native-keyboard-aware-scroll-view';
import { styles } from './style';
import { CommonBtn, CommonInput, CommonInputBtn, Header, SizeBox } from '../../Utilities/Component/Helpers';
import { height, moderateScaleVertical } from '../../Utilities/Styles/responsiveSize';
...
const EditProfile = ({ navigation }: any) => {
    ...
    const [modalVisibleSmoking, setModalVisibleSmoking] = useState<boolean>(false);
        ...
        <LinearGradient
            ...
            <SafeAreaView>
                <KeyboardAwareScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ width: "90%", alignSelf: "center", marginTop: moderateScaleVertical(30) }}>
                        <CommonBtn
                            title='Edit Profile'
                        />
                    </View>
                ...
                <Modal
                    isVisible={modalVisible || modalVisibleLang || modalVisibleDrink || modalVisibleSmoking}
                    style={{
                    ...
                    <View
                        style={{ minHeight: height / 5, maxHeight: height / 3, width: '95%', alignSelf: 'center' }}>
                        <View style={styles.modalContainer}>
                            <FlatList
                                data={modalVisible ? genders : modalVisibleLang ? lang : drinkList}
                                renderItem={({ item, index }) => {
                                    const lengthFlag = modalVisible ? genders?.length : modalVisibleLang ? lang?.length : drinkList?.length;
                                    return (
                                        <View
                                            style={[
                                                {
