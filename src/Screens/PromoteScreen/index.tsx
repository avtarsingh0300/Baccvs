      ...
      <SafeAreaView>
        <KeyboardAwareScrollView showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity style={styles.choosedatebtn}>
            <Text
              style={{...commonStyles.font10Regular, color: Colors.greyTxt}}>
              Choose Date & time
            </Text>
          </TouchableOpacity>
          <SizeBox size={10} />
          ...
          <SizeBox size={10} />
          <Text style={{...commonStyles.font14Regular, paddingLeft: 20}}>
            Demographics
          </Text>
          <SizeBox size={5} />
          <Text
          ...
          <View style={styles.customtxt}>
            <Text style={{...commonStyles.font14Regular, paddingLeft: 2}}>
              Age
            </Text>
          ...
          <SizeBox size={5} />
          <Text style={styles.letterstxt}>
            User Segmentation Based on Event Attendance
          </Text>
          <SizeBox size={5} />
          <FlatList
