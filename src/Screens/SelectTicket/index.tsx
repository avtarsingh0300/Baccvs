...
const SelectTicket = ({ navigation }) => {
    ...
    const renderItems = ({ item }) => (
        <View style={styles.item}>
            ...
            <View style={{ flexDirection: "row", paddingHorizontal: 7 ,alignItems:"center"}}>
                <View style={{ width: "72%" }}>
    ...
    return (
        ...
        >
            ...
            />
            <TouchableOpacity onPress={()=>navigation.navigate(NavigationStrings.UploadTicket)} style={styles.sytbtn}>
