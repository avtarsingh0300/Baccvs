...
const Tickets = ({navigation}) => {
    ...
    const data = [
        ...
        { id: '2', title: 'Babylone - Solum - Esposito B2B Gianni romano / Cha...',imageUrl: ImagePath.ProfileImg },
        { id: '3', title: 'Babylone - Solum - Esposito B2B Gianni romano / Cha...',imageUrl: ImagePath.ProfileImg},
       { id: '4', title: 'Babylone - Solum - Esposito B2B Gianni romano/ Cha...',imageUrl: ImagePath.ProfileImg },
      ];

      const data1 = [
        {id:'1', title: 'Babylone - Solum - Esposito B2B Giann...',imageUrl: ImagePath.ProfileImg},
        {id:'1', title: 'Babylone - Solum - Esposito B2B Giann...',imageUrl: ImagePath.ProfileImg},
        {id:'1', title: 'Babylone - Solum - Esposito B2B Giann...',imageUrl: ImagePath.ProfileImg},
        {id:'1', title: 'Babylone - Solum - Esposito B2B Giann...',imageUrl: ImagePath.ProfileImg}
      ]
  ...
  return (
   ...
   <View style={{flexDirection:"row",justifyContent:"space-between",paddingHorizontal:20,marginVertical:20}}>
    ...
    <Text onPress={()=> setColors(0)} style={[styles.tickets,{
          color: colors==0? Colors.green:Colors.white}]}>My Tickets</Text>
