...
const QrCode = () => {
  return (
    ...
    <SizeBox size={10}/>
                ...
                <ImageBackground source={ImagePath.qrbackground} style={styles.qrbckimg}>
              ...
              <Image source={ImagePath.Qrcode} style={styles.qrcodeimg}/>
                    ...
                    <View style={{flexDirection:"row",justifyContent:"center",alignItems:"center"}}>
                        <VectorIcon groupName='MaterialIcons' name='calendar-month' size={15} color={Colors.green}/>
                        <Text style={styles.datetxt}>Wednesday 20 December</Text>
                    </View>
                    <SizeBox size={4}/>
                    <View style={{flexDirection:"row",justifyContent:"center",alignItems:"center"}}>
                        <VectorIcon groupName='AntDesign' name='clockcircleo' size={13} color={Colors.green}/>
                        <Text style={styles.timetxt}>11:00 PM - 6-00 AM</Text>
                    </View>
                </ImageBackground>
                <SizeBox size={7}/>
                <Text style={styles.dotext}>Do not share your QR code. It can be used only once.</Text>
                <SizeBox size={20}/>
    ...
    <TouchableOpacity>
        <View style={styles.iconcontainer}>
            <VectorIcon groupName='MaterialCommunityIcons' name='cash-multiple' size={20}/>
        </View>
    ...
    <TouchableOpacity>
        <View style={styles.iconcontainer}>
            <VectorIcon groupName='MaterialCommunityIcons' name='transit-transfer' size={20}/>
        </View>
    ...
    <TouchableOpacity>
        <View style={styles.iconcontainer}>
            <VectorIcon groupName='MaterialCommunityIcons' name='dots-horizontal' size={20}/>
        </View>
