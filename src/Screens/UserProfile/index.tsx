import { View, Text, SafeAreaView, Image, FlatList, ScrollView, Platform, ImageBackground, TouchableOpacity } from 'react-native';
...
import { ImageComponent, SizeBox, dummydata } from '../../Utilities/Component/Helpers';
      ...
      <SafeAreaView>
        <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            <View style={{ width: "10%" }} />
            <Text style={{ ...commonStyles.Heading20font, color: Colors.Pink }}>Ben</Text>
            <VectorIcon
              groupName='Entypo'
          ...
          <View style={styles.followInfoContainer}>
            ...
            <View style={styles.followInner}>
              ...
              <Text style={[styles.followText, { color: Colors.white }]}>218</Text>
            </View>
            <View style={styles.followInner}>
          ...
          <View style={styles.statusContainer}>
            <Text style={styles.statusText}>I get it from my mama. It's a good day to have a good day.</Text>
          </View>
          <View style={styles.row}>
            ...
            <View style={{ height: moderateScaleVertical(25), paddingHorizontal: 0.5, backgroundColor: "#7D67EE" }} />
          ...
          <Text style={{ ...commonStyles.font13, fontWeight: "700", marginLeft: moderateScale(31) }}>Past events (1/11)</Text>
          <FlatList
        ...
        <Modal
          ...
          <View style={styles.optionContainer}>
            <TouchableOpacity activeOpacity={0.8} style={styles.option} onPress={() => { navigation.navigate(NavigationStrings.EditProfile); setShowModal(false); }}>
              <Text style={styles.optionText}>Edit profile</Text>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.8} style={styles.option}>
              <Text style={styles.optionText}>Edit Social part</Text>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.8} style={[styles.option, { borderBottomWidth: 0 }]}>
