...
const Profile = ({navigation}: any) => {
  ...
  const renderEvents = ({item, index}: any) => {
    ...
    return (
      <View
        style={[
          styles.ftcontainer,
          {marginRight: isLastItem ? 20 : 5, marginLeft: index == 0 ? 20 : 0},
        ]}>
        ...
        <View style={{paddingLeft: 7}}>
          ...
          <Text style={{...commonStyles.font14Regular, color: Colors.black}}>
            Eric Prydz
          </Text>
        </View>
      </View>
  ...
  const renderMusic = ({item}) => (
    <View style={{alignSelf: 'center'}}>
      <TouchableOpacity
        style={[styles.button, {backgroundColor: Colors.lightPink}]}>
    ...
    return (
      <View>
        <View
          style={[
            styles.imagecon,
            {marginRight: isLastItem ? 20 : 5, marginLeft: index == 0 ? 5 : 0},
          ]}>
    ...
    return (
      <View style={styles.outerVw}>
        ...
        <Text style={styles.review}>
          We couldn’t go to ibiza, so ibiza vibes came to us thanks to the
          amazing performance of Sasha !
        </Text>
      </View>
    );
  };
    ...
    <LinearGradient
      ...
      <SafeAreaView>
        <KeyboardAwareScrollView showsVerticalScrollIndicator={false}>
          ...
          <SizeBox size={10} />
          <Text style={{...commonStyles.font16Regular, paddingHorizontal: 20}}>
            Upcoming events (18)
          </Text>
          <SizeBox size={10} />
          <FlatList
