...
import DropComponentNew, {Item} from './DropComponentNew';
              ...
              <View
                ...
                <View
                  ...
                  <DropComponentNew
                    ...
                    selectedItems={selectedInterests.map(item => item._id)}
                  />
                </View>
              </View>
              <SizeBox size={10} />
              ...
              <View
                ...
                <View
                  ...
                  <DropComponentNew
                    ...
                    selectedItems={selectedLanguage.map(item => item._id)}
                  />
                </View>
              </View>
              <SizeBox size={10} />
                ...
                <View
                  ...
                  <View
                    ...
                    <DropComponentNew
                      ...
                      selectedItems={selectedAstroSigns.map(item => item._id)}
                    />
                  </View>
                </View>
                <SizeBox size={10} />
