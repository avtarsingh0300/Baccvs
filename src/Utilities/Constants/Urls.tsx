...
export const EVENT_TICKET_DETAIL = getApiUrl('event-ticket');
...
export const BUY_EVENT_TICKET = getApiUrl('buy-ticket');
...
export const COMMENT_ON_MEDIA = getApiUrl('comment-media');
